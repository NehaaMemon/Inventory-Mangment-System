            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="fs-22 mb-0 me-2 fw-semibold text-black">
                        <strong class="text-muted">{{ $purchase }}</strong>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="fs-22 mb-0 me-2 fw-semibold text-black">
                        <strong class="text-muted">{{ $purchaseReturn }}</strong>
                    </p>
                </div>
            </div>
        </div>
...
<div class="col-md-4 col-lg-4">
    <div class="card mb-3" style="max-width: 400px; background-color:rgb(138, 197, 241)">
        <div class="row g-0">
            <div class="col-4 d-flex align-items-center justify-content-center" style="height: 100px;">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="fs-22 mb-0 me-2 fw-semibold text-black">
                        <strong class="text-muted">{{ $salesCount }}</strong>
                    </p>
                </div>
            </div>
        </div>
...
<div class="col-md-4 col-lg-4">
    <div class="card mb-3" style="max-width: 400px; background-color:rgb(233, 137, 248)">
        <div class="row g-0">
            <div class="col-4 d-flex align-items-center justify-content-center" style="height: 100px;">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <p class="fs-22 mb-0 me-2 fw-semibold text-black">
                        <strong class="text-muted">{{ $salesReturn}}</strong>
                    </p>
                </div>
            </div>
        </div>
