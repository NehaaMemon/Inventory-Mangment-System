...
<script>
   ...
   const filterSalesUrl = @json(route('filter-sales', [], false));
   ...
   document.getElementById("date-range").addEventListener("change", function () {
    ...
    function fetchFilteredData(startDate, endDate) {
        const requestUrl = `${filterSalesUrl}?start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}`;
    ...
    function updateTable(sales) {
        ...
        if (!Array.isArray(sales)) {
            console.warn('Unexpected sales payload:', sales);
            return;
        }
        ...
        sales.forEach(sale => {
            const items = Array.isArray(sale.sale_items)
             ? sale.sale_items
                : (Array.isArray(sale.saleItems) ? sale.saleItems : []);
