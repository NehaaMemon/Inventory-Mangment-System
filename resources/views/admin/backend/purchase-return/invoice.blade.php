...
<body>
    <div class="invoice-container">
        ...
        <table class="info-section">
            <tr>
                ...
                <td class="info-box">
                    ...
                    <p><strong>Grand Total:</strong> PKR{{ $purchase->grand_total }} </p>
                </td>
            </tr>
        </table>
        ...
        <table class="summary-table">
            <tr>
                <td><strong>Total Discount:</strong> PKR {{ $purchase->discount }} </td>
            </tr>
            <tr>
                <td><strong>Shipping Cost:</strong> PKR {{ $purchase->shipping }} </td>
            </tr>
            <tr>
                <td><strong>Grand Total:</strong> PKR {{ $purchase->grand_total }} </td>
            </tr>
        </table>
    </div>
</body>
