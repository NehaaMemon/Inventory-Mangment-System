    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        ...
        <div class="text-end">
            <ol class="breadcrumb m-0 py-0">
                <a href="{{ route('return-purchase.create') }}" class="btn btn-secondary">
                    Add Return Purchase
                </a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($item->status === 'Return')
                        <span class="badge bg-success main-btn">Return</span>
                    ...
                    <td>{{ $item->created_at->format('d-m-Y H:i A') }}
                        ...
                        <th>
                        <a title="Edit" href="{{ route('return-purchase.edit',$item->id) }}"
                            class="btn btn-warning"><i class="fa-solid fa-pen-to-square">
                                </i></a>

                        <a title="Detail" href="{{ route('return-purchase.detail',$item->id) }}"
                            class="btn btn-info"><i class="fa-regular fa-eye"></i></a>

                        <a title="PDF Invoice" href="{{ route('return-purchase.invoice',$item->id) }}"
                             class="btn btn-primary"><i class="fa-solid fa-download"></i></a>

                <form action="{{ route('return-purchase.delete', $item->id) }}" method="POST" class="delete-form" style="display:inline;">
                        @csrf
                        @method('DELETE')
