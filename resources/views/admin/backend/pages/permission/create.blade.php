    ...
    <div class="content">
        ...
        <div class="container-xxl">
            ...
            <div class="flex-grow-1">
                <h2 class="fs-22 fw-semibold m-0">Add Permission</h2>
            </div>
            <div class="text-end">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST" action="{{ route('store.permission') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="group_name" class="form-select @error('group_name') is-invalid @enderror">
                                            ...
                                            <option value="sale">Sale Manage</option>
                                            <option value="purchase">Purchase Manage</option>
