...
<body>
    <div class="invoice-container">
            ...
            <tr>
                ...
                <td class="info-box">
                    ...
                    <p><strong>Status:</strong> {{ $sale->status}} </p>
                     <p><strong>Paid Amount:</strong> PKR{{ $sale->paid_amount }} </p>
                      <p><strong>Due Amount:</strong> PKR{{ $sale->due_amount }} </p>
                    <p><strong>Grand Total:</strong> PKR{{ $sale->grand_total }} </p>
                </td>
            </tr>
        </table>
        ...
        <table class="summary-table">
            <tr>
                <td><strong>Total Discount:</strong> PKR {{ $sale->discount }} </td>
            </tr>
            <tr>
                <td><strong>Shipping Cost:</strong> PKR {{ $sale->shipping }} </td>
            </tr>
            <tr>
                <td><strong>Grand Total:</strong> PKR {{ $sale->grand_total }} </td>
            </tr>
        </table>
    </div>
</body>
