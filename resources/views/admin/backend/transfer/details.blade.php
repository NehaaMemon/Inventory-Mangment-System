   ...
   <div class="d-flex flex-column-fluid">
      <div class="container-fluid my-4">
         <div class="d-md-flex align-items-center justify-content-between">
            <h3 class="mb-0"> Transfer Detail</h3>
            <div class="text-end my-2 mt-md-0"><a class="btn btn-dark" href="{{ route('sale-return.index') }}">Back</a></div>
         </div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                style="transition: 0.2s; border-radius:10px;"
                >
            ...
            <div class="col-md-4 mb-4">
                ...
                style="background:linear-gradient(135deg,#17a2b8,#0d6efd);border-radius: 10px 10px 0 0;"
                >
                <h5 class="mb-0 fw-bold">From WareHouse Information</h5>
                </div>
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-3">
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <strong class="me-2 text-muted">To WareHouse : </strong>
