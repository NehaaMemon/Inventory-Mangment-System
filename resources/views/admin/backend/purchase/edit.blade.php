...
<div class="content d-flex flex-column flex-column-fluid">
 ...
 <div class="card">
    <div class="card-body">
    <form action="{{ route('purchase.update',$purchasedata->id)}}" method="post" enctype="multipart/form-data">
       @csrf
         ...
         <div class="col-md-4">
            <div class="form-group w-100">
               ...
               <select name="status" id="status" class="form-control form-select">
                  ...
                  <option value="Received" {{ $purchasedata->status == 'Received' ? 'selected' : '' }} >Received</option>
