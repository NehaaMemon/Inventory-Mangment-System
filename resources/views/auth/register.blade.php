                                ...
                                <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                                    ...
                                    <div class="pt-0">
                                        ...
                                        <form method="POST" action="{{ route('register') }}">
                                                ...
                                                <input class="form-control"  type="text" id="username" required="" placeholder="Enter your Username" name="name">
                                            </div>
                                            ...
                                            <div class="form-group mb-3">
                                              ...
                                              <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" type="password" required="" id="password" placeholder="Enter your password"  name="password_confirmation">
                                            </div>
