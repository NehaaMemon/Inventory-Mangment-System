                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            ...
                            <div class="maintenance-img">
                                <img src="{{ asset('backend/assets/images/svg/404-error.svg')}}" class="img-fluid" alt="404 error">
                            </div>

                            <div class="text-center">
                                <h3 class="mt-5 fw-semibold text-black text-capitalize">Oops! Page not found</h3>
                                <p class="text-muted">The page you are trying to access does not exist or has been moved. <br> Try going back to the dashboard.</p>
                            </div>
